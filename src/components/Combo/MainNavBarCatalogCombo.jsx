...
export function MainNavBarCatalogCombo() {
    ...
    return (
        <>
            <MainNavBar setDisplay={changeDisplay} dialog={dialog} setDialog={setDialog} openCart={() => setCartOpen(true)} /> 
            ...
            <Cart onClose={() => setCartOpen(false)} initialItems={null} isOpen={cartOpen} /> 
